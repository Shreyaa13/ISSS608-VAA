...
By the end of this hands-on exercise, we will:
...
-   [tidyverse](https://www.tidyverse.org/) - A collection of R packages for data science tasks like importing, tidying, wrangling, and visualizing data (e.g., readr, dplyr, ggplot2, tidyr, etc.).
-   [lubridate](https://r4va.netlify.app/chap31) - Simplifies working with dates and times in R.
-   [ggthemes](https://r4va.netlify.app/chap31) - Adds extra themes for ggplot2 visualizations.
-   [gtExtras](https://jthomasmock.github.io/gtExtras/index.html) - Enhances [gt](https://gt.rstudio.com/) tables with additional formatting and styling functions.
-   [reactable](https://glin.github.io/reactable/index.html) - Creates interactive data tables in R using the [React Table](https://github.com/tanstack/table/tree/v7) library.
-   [reactablefmtr](https://kcuilla.github.io/reactablefmtr/index.html) - Adds styling and customization tools for reactable tables.
...
**Note:** In the above code chunk, the `odbcConnectAccess()` is based on 32bit and not 64bit. Since my R system version is 64 bit, we can't use the above code and will instead directly import the data.
...
Refer to the code chunk used below.
...
In this section, we learn how to create static information dashboards using the [gt](https://gt.rstudio.com/) and [gtExtras](https://jthomasmock.github.io/gtExtras/index.html) packages. It's recommended to visit their official webpages to just get a general sense of their features and capabilities.

## 10.5.1 Plotting a simple bullet chart

In this section, we will prepare a bullet chart report using functions of gt and gtExtras packages.
...
First, calculate summary statistics using the code chunk below.
...
In this section, we learn how to create interactive information dashboards using the [reactable](https://glin.github.io/reactable/index.html) and [reactablefmtr](#0) packages. It's recommended to visit their official webpages to just get a general sense of their features and capabilities.

In order to build an interactive sparklines, we need to install dataui R package using the code chunk below.

```{r}
remotes::install_github("timelyportfolio/dataui")
```

Next, we need to load the package onto R environment.
