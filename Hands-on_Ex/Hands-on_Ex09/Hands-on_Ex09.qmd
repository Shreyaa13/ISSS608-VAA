...
pacman::p_load(igraph, tidygraph, ggraph, 
               ...
               tidyverse, graphlayouts, ggforce,
               concaveman)
```
...
![](images/clipboard-2852427744.png){width="570"}

![](images/clipboard-1911961357.png){width="570"}
